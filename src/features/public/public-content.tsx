...
export function PublicContentPage({ document, portfolioSlug, item, kind, basePath }: { document: SiteDocument; portfolioSlug: string; item: Page | Post; kind: "page" | "post"; basePath?: string }) {
  ...
  return <main className={`published-content-page bg-${document.design.background} template-${document.design.template} ${document.design.template === "professional-2d" ? "light-theme" : ""}`} data-accent={document.design.accent}>
